...
- This is the simple dialog version
- [State machine version is here](https://github.com/Quasic/termux-home-bin/tree/master)
...
- Testing note: I currently only test this on Android 11. I tested Android 5 and 7 in the past. [See issue #1](https://github.com/Quasic/termux-home-bin/issues/1). I now have switched to [a more dynamic script I use on all devices.](https://github.com/Quasic/termux-home-bin/tree/master) This one may continue to be updated, but in a more limited capacity. If you test on another Android/Termux version, please report results in the issues.
